        ...
        <script src="<?= base_url('asset')?>/plugins/popper.js/dist/umd/popper.min.js"></script>
        <script src="<?= base_url('asset')?>/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="<?= base_url('asset')?>/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
        <script src="<?= base_url('asset')?>/plugins/screenfull/dist/screenfull.js"></script>
        <script src="<?= base_url('asset')?>/plugins/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="<?= base_url('asset')?>/plugins/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
        <script src="<?= base_url('asset')?>/dist/js/theme.min.js"></script>
